...
def test_get_gai_config():
    ...
    assert config["generators"]["ttt"]["default"]=="ttt-exllamav2-dolphin"
...
def test_get_default_server_config():
    ...
    # assert
    assert llm_config.name=="ttt-exllamav2-dolphin"
...
def test_get_named_server_config():
    ...
    # Load default config
    from gai.ttt.server.config.server_config_utils import get_llm_config
    llm_config = get_llm_config("ttt-exllamav2-mistral7b",config_path)
    print(llm_config)
    
    # assert
    assert llm_config.name=="ttt-exllamav2-mistral7b"
